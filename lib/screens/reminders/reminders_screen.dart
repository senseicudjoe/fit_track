...
class _AddReminderSheet extends StatefulWidget {
  ...
  const _AddReminderSheet({
    required this.uid, required this.onSave, required this.uuid,
  });
...
class _AddReminderSheetState extends State<_AddReminderSheet> {
  ...
  String _timeOfDay = '07:00';
  List<int> _days   = [0, 1, 2, 3, 4]; // weekdays by default
  bool _saving      = false;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Add reminder', style: AppTextStyles.heading2),
